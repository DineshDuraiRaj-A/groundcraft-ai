...
async def _call_free_with_fallback(messages: list[dict], temperature: float,
    ...
    raise ProviderError(
        "Every free model is currently unavailable. Usually this means the daily "
        "free limit has been reached, or the provider's free roster changed. "
        "Adding a CEREBRAS_API_KEY gives a much larger free allowance. "
